...
\[IMAGE HERE — training and validation loss curves from WandB\]
...
\[IMAGE HERE — per-tree prediction visualization: ground truth (green) vs. predictions (red) on a test tile\]
...
→ [**Open in Kaggle**](https://www.kaggle.com/code/emanuelgoulart/abg-dl-regressor)  \|  [**GitHub Repository**](https://github.com/emanuel-gf/ReforesTree)
:::
